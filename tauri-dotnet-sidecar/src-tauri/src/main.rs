...
fn spawn_and_monitor_sidecar(app_handle: tauri::AppHandle) -> Result<(), String> {
    ...
    let sidecar_command = app_handle
        .shell()
        .sidecar("server") // Name of the sidecar binary without extension
...
fn main() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // Spawn the dotnet sidecar on startup
        ...
        .run(|app_handle, event| match event {
            // Ensure the dotnet sidecar is killed when the app is closed
